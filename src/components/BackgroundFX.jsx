...
function Cross({ size = 20, strokeWidth = 1, opacity = 0.5 }) {
  ...
  return (
    <svg width={size} height={size} viewBox={`0 0 ${size} ${size}`} style={{ opacity }}>
      <line x1={h} y1="0" x2={h} y2={size} stroke="currentColor" strokeWidth={strokeWidth} />
      <line x1="0" y1={h} x2={size} y2={h} stroke="currentColor" strokeWidth={strokeWidth} />
    </svg>
  )
}
...
export default function BackgroundFX() {
  ...
  return (
    <div className="pointer-events-none select-none" style={{ color: 'var(--lime-text)' }}>
      ...
      <div className="fixed top-0 right-0 z-[2] overflow-hidden"
        ...
        <svg width="640" height="640" viewBox="0 0 640 640" fill="none">
          <circle ref={ring1Ref} cx="320" cy="320" r="300"
            stroke="currentColor" strokeWidth="0.6" strokeOpacity="0.1" strokeDasharray="5 18" />
          <circle ref={ring2Ref} cx="320" cy="320" r="210"
            stroke="currentColor" strokeWidth="0.5" strokeOpacity="0.07" strokeDasharray="2 10" />
          <circle cx="320" cy="320" r="120"
            stroke="currentColor" strokeWidth="0.5" strokeOpacity="0.05" />
          <circle cx="320" cy="320" r="4" fill="currentColor" fillOpacity="0.15" />
          <line x1="270" y1="320" x2="370" y2="320" stroke="currentColor" strokeWidth="0.5" strokeOpacity="0.12" />
          <line x1="320" y1="270" x2="320" y2="370" stroke="currentColor" strokeWidth="0.5" strokeOpacity="0.12" />
        </svg>
      </div>
      ...
      <div className="fixed bottom-0 left-0 z-[2]"
        ...
        <svg width="480" height="480" viewBox="0 0 480 480" fill="none">
          <circle ref={ring3Ref} cx="240" cy="240" r="220"
            stroke="currentColor" strokeWidth="0.6" strokeOpacity="0.08" strokeDasharray="4 14" />
          <circle cx="240" cy="240" r="145"
            stroke="currentColor" strokeWidth="0.5" strokeOpacity="0.05" />
          <circle cx="240" cy="240" r="4" fill="currentColor" fillOpacity="0.1" />
        </svg>
      </div>
      ...
      <div className="fixed z-[2]" style={{ top: '12%', left: -50, opacity: 0.08 }}>
        <svg width="200" height="200" viewBox="0 0 200 200" fill="none">
          <path d="M 200 0 A 200 200 0 0 0 0 200" stroke="currentColor" strokeWidth="1" />
          <path d="M 155 0 A 155 155 0 0 0 0 155" stroke="currentColor" strokeWidth="0.6" strokeDasharray="4 10" />
          <path d="M 110 0 A 110 110 0 0 0 0 110" stroke="currentColor" strokeWidth="0.5" />
        </svg>
      </div>
      ...
      <div className="fixed bottom-0 right-0 z-[2]" style={{ opacity: 0.13 }}>
        <svg width="40" height="40" viewBox="0 0 40 40" fill="none">
          <line x1="40" y1="20" x2="20" y2="20" stroke="currentColor" strokeWidth="1" />
          <line x1="20" y1="40" x2="20" y2="20" stroke="currentColor" strokeWidth="1" />
        </svg>
      </div>
